...
export default function DashboardSimple({ title = "Dashboard", userName = "User" }) {
  return (
    <div style={{
      padding: '24px',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div id="stats-placeholder" style={{ color: '#888' }}>
            Stats will be loaded here as a nested fractal...
          </div>
        </div>
      ...
      <div style={{
        ...
        Dashboard Fractal Component - Ready for nested fractals
      </div>
    </div>
  );
}